...
def showMap(room):
    print('┏━━━━━━━━━┳━━━━━━━━━┳━━━ ⬆ ━━━┳━━━━━━━━━┳━━━━━━━━━┓')
    print('┃         ┃         ┃  EXIT   ┃         ┃         ┃')
    print('┃    '+('X' if room.name == 'A1' else ' ')+'         '+('X' if room.name == 'A2' else ' ')+'    ┃    '+('X' if room.name == 'A3' else ' ')+'    ┃    '+('X' if room.name == 'A4' else ' ')+'         '+('X' if room.name == 'A5' else ' ')+'    ┃')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┣━━━   ━━━╋━━━━━━━━━╋━━━   ━━━╋━━━   ━━━╋━━━   ━━━┫')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┃    '+('X' if room.name == 'B1' else ' ')+'         '+('X' if room.name == 'B2' else ' ')+'         '+('X' if room.name == 'B3' else ' ')+'         '+('X' if room.name == 'B4' else ' ')+'    ┃    '+('X' if room.name == 'B5' else ' ')+'    ┃')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┣━━━   ━━━╋━━━━━━━━━╋━━━━━━━━━╋━━━━━━━━━╋━━━   ━━━┫')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┃    '+('X' if room.name == 'C1' else ' ')+'         '+('X' if room.name == 'C2' else ' ')+'         '+('X' if room.name == 'C3' else ' ')+'         '+('X' if room.name == 'C4' else ' ')+'         '+('X' if room.name == 'C5' else ' ')+'    ┃')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┣━━━━━━━━━╋━━━━━━━━━╋━━━   ━━━╋━━━━━━━━━╋━━━   ━━━┫')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┃    '+('X' if room.name == 'D1' else ' ')+'         '+('X' if room.name == 'D2' else ' ')+'         '+('X' if room.name == 'D3' else ' ')+'         '+('X' if room.name == 'D4' else ' ')+'         '+('X' if room.name == 'D5' else ' ')+'    ┃')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┣━━━━━━━━━╋━━━━━━━━━╋━━━   ━━━╋━━━━━━━━━╋━━━━━━━━━┫')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┃    '+('X' if room.name == 'E1' else ' ')+'         '+('X' if room.name == 'E2' else ' ')+'         '+('X' if room.name == 'E3' else ' ')+'         '+('X' if room.name == 'E4' else ' ')+'         '+('X' if room.name == 'E5' else ' ')+'    ┃')
    print('┃         ┃         ┃         ┃         ┃         ┃')
    print('┗━━━━━━━━━┻━━━━━━━━━┻━━━━━━━━━┻━━━━━━━━━┻━━━━━━━━━┛')
    input('\nContinue...')