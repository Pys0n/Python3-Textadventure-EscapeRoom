...
def main():
    ...
    while escape:
        ...
        if room.dn: print('W - Go North' if room.n_information == None else 'W - Go North ['+room.n_information+']')
        elif room.n_information != None: print('W - ['+room.n_information+']')
        if room.dw: print('A - Go West'  if room.w_information == None else 'A - Go West  ['+room.w_information+']')
        elif room.w_information != None: print('A - ['+room.w_information+']')
        if room.ds: print('S - Go South' if room.s_information == None else 'S - Go South ['+room.s_information+']')
        elif room.s_information != None: print('S - ['+room.s_information+']')
        if room.de: print('D - Go East'  if room.e_information == None else 'D - Go East  ['+room.e_information+']')
